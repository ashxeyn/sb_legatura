...
class projectsRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'building_permit' => ($isCreate ? 'required' : 'nullable') . '|file|mimes:jpg,jpeg,png,pdf,doc,docx|max:10240',
            'title_of_land' => ($isCreate ? 'required' : 'nullable') . '|file|mimes:jpg,jpeg,png,pdf,doc,docx|max:10240',
    ...
    public function messages()
    {
        return [
            ...
            'building_permit.mimes' => 'Building permit must be JPG, JPEG, PNG, PDF, DOC, or DOCX format.',
            'title_of_land.required' => 'Title of land file is required for new posts.',
            'title_of_land.file' => 'Title of land must be a valid file.',
            'title_of_land.mimes' => 'Title of land must be JPG, JPEG, PNG, PDF, DOC, or DOCX format.',
