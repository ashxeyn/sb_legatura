...
class disputeRequest extends FormRequest
{
        ...
        $rules = [
            'project_id' => [
                ...
                function ($attribute, $value, $fail) {
                    ...
                    if ($project && empty($project->contractor_user_id)) {
            ...
            'dispute_type' => 'required|string|in:Payment,Delay,Quality,Halt,Terminate,Others',
    ...
    public function messages()
    {
        return [
            ...
            'dispute_type.in' => 'Invalid dispute type selected. Must be Payment, Delay, Quality, Halt, Terminate, or Others.',
