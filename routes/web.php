...
Route::post('/admin/project-management/disputes/{id}/halt-project', [projectManagementController::class, 'haltProjectFromDispute'])->name('admin.projectManagement.haltProjectFromDispute');
