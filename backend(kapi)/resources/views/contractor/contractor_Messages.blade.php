...
@section('content')
    <div class="contractor-messages bg-gray-50">
        <div class="messages-card-container max-w-7xl mx-auto">
            <div class="messages-card bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="messages-conversation-list flex-1 overflow-y-auto" id="conversationList">
                    ...
                    <!-- Sample Conversations with Property Owners -->
            ...
            <div class="modal-body">
                ...
                <div class="recipient-search-section">
                    <div class="recipient-search-container">
                        ...
                        <input type="text" class="recipient-search-input" id="recipientSearchInput" placeholder="Search property owners...">
                    </div>
                </div>

                <!-- Recipients List -->
                <div class="recipients-list" id="recipientsList">
                    <!-- Sample Property Owners (will be replaced with dynamic data) -->
                    <div class="recipient-item" data-recipient-id="1" data-recipient-name="Lisa Anderson">
                        <div class="recipient-avatar avatar-red">
                            <span>LA</span>
                        </div>
                        <div class="recipient-info">
                            <div class="recipient-name">Lisa Anderson</div>
                            <div class="recipient-specialty">Property Owner</div>
                        </div>
                    ...
                    <div class="recipient-item" data-recipient-id="2" data-recipient-name="Michael Torres">
                        <div class="recipient-avatar avatar-green">
                            <span>MT</span>
                        </div>
                        <div class="recipient-info">
                            <div class="recipient-name">Michael Torres</div>
                            <div class="recipient-specialty">Property Owner</div>
                        </div>
                    ...
                    <div class="recipient-item" data-recipient-id="3" data-recipient-name="Emma Wilson">
                        <div class="recipient-avatar avatar-blue">
                            <span>EW</span>
                        </div>
                        <div class="recipient-info">
                            <div class="recipient-name">Emma Wilson</div>
                            <div class="recipient-specialty">Property Owner</div>
                        </div>
                    ...
                    <div class="recipient-item" data-recipient-id="4" data-recipient-name="Robert Kim">
                        <div class="recipient-avatar avatar-orange">
                            <span>RK</span>
                        </div>
                        <div class="recipient-info">
                            <div class="recipient-name">Robert Kim</div>
                            <div class="recipient-specialty">Property Owner</div>
                        </div>
                    ...
                    <div class="recipient-item" data-recipient-id="5" data-recipient-name="David Park">
                        <div class="recipient-avatar avatar-red">
                            <span>DP</span>
                        </div>
                        <div class="recipient-info">
                            <div class="recipient-name">David Park</div>
                            <div class="recipient-specialty">Property Owner</div>
                        </div>
...
@section('extra_css')
    <link rel="stylesheet" href="{{ asset('css/contractor/contractor_Messages.css') }}">
    <style>
...
@section('extra_js')
    <script src="{{ asset('js/contractor/contractor_Messages.js') }}"></script>
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            navbarLinks.forEach(link => {
                ...
                if (link.textContent.trim() === 'Messages' || link.getAttribute('href') === '{{ route("contractor.messages") }}') {
