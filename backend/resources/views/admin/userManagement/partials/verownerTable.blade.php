                  ...
                  <tr class="hover:bg-gray-50 transition duration-150 ease-in-out group">
                    <td class="px-6 py-4">
                      <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-full bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center text-white font-semibold shadow-md flex-shrink-0">
                          {{ strtoupper(substr($request->first_name ?? $request->username, 0, 2)) }}
                        </div>
                    ...
                    <td class="px-6 py-4">
                      <div class="flex items-center justify-center gap-2">
                        <button class="p-2 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 transition po-view-btn" data-key="{{ $request->user_id }}" title="View">
            ...
            <div class="px-6 py-4 border-t border-gray-200">
                {{ $ownerRequests->appends(request()->query())->links() }}
            </div>
