...
@section('content')
    <div class="property-owner-finishedprojects min-h-screen bg-gray-50">
        <!-- Header Section -->
        <div class="finishedprojects-header bg-white shadow-md">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div id="emptyState" class="hidden text-center py-16">
                <i class="fi fi-rr-check-circle text-6xl text-gray-300 mb-4"></i>
...
@section('extra_css')
    <link rel="stylesheet" href="{{ asset('css/owner/propertyOwner_Finishedprojects.css') }}">
...
@section('extra_js')
    ...
    <script src="{{ asset('js/owner/propertyOwner_Finishedprojects.js') }}"></script>
    <script>
