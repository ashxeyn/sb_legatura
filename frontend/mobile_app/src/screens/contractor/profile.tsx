...
export default function ContractorProfileScreen({ onLogout, onOpenHelp, onOpenSwitchRole, userData }: ContractorProfileScreenProps) {
  ...
  // Get initials from company name or username for avatar fallback
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          subtitle: 'Manage your business documents',
          showArrow: true,
          onPress: () => Alert.alert('Coming Soon', 'This feature is under development.'),
        },
      ],
    ...
    >
      <View style={[styles.menuIconContainer, item.danger && styles.menuIconDanger]}>
        <Ionicons
          ...
          size={22}
          color={item.danger ? '#E74C3C' : '#1877F2'}
        />
      </View>
          ...
          <View style={styles.profileInfoContainer}>
            ...
            <View style={styles.badgeRow}>
              ...
              {userData?.contractor_type && (
                <View style={styles.contractorTypeBadge}>
                  ...
                  <Text style={styles.contractorTypeText}>{userData.contractor_type}</Text>
                </View>
              )}
            </View>
            ...
            {userData?.years_of_experience !== undefined && (
              <Text style={styles.experienceText}>
                {userData.years_of_experience} {userData.years_of_experience === 1 ? 'year' : 'years'} of experience
              </Text>
            )}
          </View>
        </View>
