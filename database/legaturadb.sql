...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 29, 2026 at 05:48 AM
...
(1, 'admin123', 'admin@gmail.com', '$2y$12$wN6x17yJegWeKIUj3Lq8O.sAG6QfX.5OPQ13k0xSAY./xrDhej5Uq', 'admin', 'admin', 'admin', 1, '2025-10-25 07:19:23');
...
ALTER TABLE `bid_files`
  ...
  ADD KEY `bid_files_ibfk_1` (`bid_id`);
...
ALTER TABLE `dispute_files`
  ADD PRIMARY KEY (`file_id`),
  ADD KEY `dispute_files_ibfk_1` (`dispute_id`);
...
ALTER TABLE `item_files`
  ADD PRIMARY KEY (`file_id`),
  ADD KEY `item_files_ibfk_1` (`item_id`);
...
ALTER TABLE `milestones`
  ...
  ADD KEY `milestones_ibfk_2` (`contractor_id`),
  ADD KEY `milestones_ibfk_3` (`plan_id`);
...
ALTER TABLE `milestone_items`
  ...
  ADD KEY `milestone_items_ibfk_1` (`milestone_id`);
...
ALTER TABLE `milestone_payments`
  ...
  ADD KEY `milestone_payments_ibfk_1` (`item_id`),
  ADD KEY `milestone_payments_ibfk_3` (`project_id`),
  ADD KEY `milestone_payments_ibfk_4` (`owner_id`),
  ADD KEY `milestone_payments_ibfk_5` (`contractor_user_id`);
...
ALTER TABLE `payment_plans`
  ...
  ADD KEY `payment_plans_ibfk_1` (`project_id`),
  ADD KEY `payment_plans_ibfk_2` (`contractor_id?`);
...
ALTER TABLE `platform_payments`
  ...
  ADD KEY `platform_payments_ibfk_1` (`project_id`),
  ADD KEY `platform_payments_ibfk_2` (`contractor_id`),
  ADD KEY `platform_payments_ibfk_3` (`owner_id?`),
  ADD KEY `platform_payments_ibfk_4` (`approved_by`);
...
ALTER TABLE `reviews`
  ...
  ADD KEY `reviews_ibfk_1` (`project_id`),
  ADD KEY `reviews_ibfk_2` (`reviewer_user_id`),
  ADD KEY `reviews_ibfk_3` (`reviewee_user_id`);
