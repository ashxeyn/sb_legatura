...
<body>
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="details-section">
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-value">
                        <a href="{{ asset('storage/' . $blueprintFile->file_path) }}" target="_blank" style="color: #5cb85c; text-decoration: underline;">
                            View Blueprint
                        </a>
                    </div>
                </div>
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-value">
                        <a href="{{ asset('storage/' . $landTitleFile->file_path) }}" target="_blank" style="color: #5cb85c; text-decoration: underline;">
                            View Land Title
                        </a>
                    </div>
                </div>
                    ...
                    <div class="detail-value">
                        @foreach($supportingDocuments as $doc)
                            <div style="margin-bottom: 5px;">
                                <a href="{{ asset('storage/' . $doc->file_path) }}" target="_blank" style="color: #5cb85c; text-decoration: underline;">
        ...
        <div class="actions">
            <a href="/owner/projects/create" class="btn btn-primary">Post Another Project</a>
        </div>
    </div>
