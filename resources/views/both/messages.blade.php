@php
    // Detect current role for dynamic layout and assets
    $currentRole = session('current_role', session('userType'));
    $isContractor = in_array($currentRole, ['contractor', 'both']);
            ...
            <div class="messages-main flex-1 flex flex-col bg-gray-50">
                ...
                <div class="messages-input-area bg-white border-t border-gray-200 p-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button type="button" class="messages-attach-btn" id="attachmentBtn" aria-label="Attach file">
                            ...
                            <input type="file" id="attachmentInput" multiple accept="image/*,.pdf,.doc,.docx" class="hidden">
                        </button>
        ...
        <div class="modal-container">
            ...
            <div class="modal-body">
                ...
                <div class="recipient-search-section">
                    ...
                    <div id="composeRecipientsWrapper" class="w-full flex flex-wrap gap-2 px-3 py-2 border-2 border-gray-200 rounded-xl focus-within:ring-2 focus-within:ring-indigo-300 focus-within:border-indigo-300 bg-white cursor-text" style="min-height: 42px;">
                        <input type="text" class="flex-1 min-w-[140px] outline-none text-sm bg-transparent" id="composeRecipientSearch" placeholder="{{ $isContractor ? 'Search property owners...' : 'Search contractors...' }}">
                    </div>
                    <!-- Recipient Dropdown -->
                    <div id="composeRecipientDropdown" class="hidden mt-2 bg-white border border-gray-200 rounded-xl shadow-lg max-h-48 overflow-y-auto text-sm"></div>
                ...
                <div class="mt-4">
                    ...
                    <div id="composeAttachmentDrop" class="border-2 border-dashed border-gray-300 rounded-xl p-4 flex flex-col items-center justify-center gap-2 text-center cursor-pointer bg-gray-50 hover:bg-gray-100 transition">
