...
<body>
    <div class="container">
        ...
        <div id="projectFormSuccess" class="alert alert-success" style="display: none;"></div>
        <div id="projectFormError" class="alert alert-error" style="display: none;"></div>
    ...
    <script>
        // Set old barangay value for form repopulation after validation errors
        document.addEventListener('DOMContentLoaded', function() {
            const barangaySelect = document.getElementById('project_barangay');
            const oldBarangay = {!! json_encode(old('barangay')) !!};
            if (barangaySelect && oldBarangay) {
                barangaySelect.setAttribute('data-old-value', oldBarangay);
            }
        });
    </script>
