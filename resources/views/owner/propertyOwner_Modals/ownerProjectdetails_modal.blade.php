...
<div id="projectDetailsModal" class="pdm-modal" role="dialog" aria-modal="true" aria-labelledby="pdmDialogTitle">
    ...
    <div class="pdm-dialog">
        ...
        <div class="pdm-body" id="pdmScrollBody">
            ...
            <div class="pdm-two-column-layout" id="twoColumnSection">

                {{-- Left Column: Project Files --}}
                <div class="pdm-files-column">
                    {{-- First Row: Design Files (Larger) --}}
                    <div class="pdm-files-section">
                        <div class="pdm-files-header">
                            <i class="fi fi-rr-blueprint"></i>
                            <span class="pdm-files-title">Design Files</span>
                        </div>
                        <div class="pdm-files-grid pdm-files-grid-large" id="projectDesignFiles">
                    ...
                    <div class="pdm-files-section">
                        <div class="pdm-files-header">
                            ...
                            <span class="pdm-files-title">Legal Documents</span>
                        </div>
                        <div class="pdm-files-grid pdm-files-grid-small" id="projectLegalFiles">
                            <div class="pdm-files-empty">
                ...
                <div class="pdm-info-column">
                    <div class="pdm-info-card">
                        <div class="pdm-info-header">
                            <i class="fi fi-rr-info"></i>
                            <span>Project Information</span>
                        </div>

                        <div class="pdm-info-body">
                            {{-- Status --}}
                            <div class="pdm-info-row">
                                <span class="pdm-info-label">Status</span>
                                <span class="pdm-info-value" id="infoStatus"></span>
                            </div>

                            {{-- Posted --}}
                            <div class="pdm-info-row">
                                <span class="pdm-info-label">Posted</span>
                                <span class="pdm-info-value" id="infoPosted"></span>
                            </div>

                            {{-- Deadline --}}
                            <div class="pdm-info-row" id="infoDeadlineRow" style="display:none">
                                <span class="pdm-info-label">Deadline</span>
                                <span class="pdm-info-value" id="infoDeadline"></span>
                            </div>

                            {{-- Bids --}}
                            <div class="pdm-info-row">
                                <span class="pdm-info-label">Bids</span>
                                <span class="pdm-info-value" id="infoBids"></span>
                            </div>

                            {{-- Budget Range --}}
                            <div class="pdm-info-row">
                                <span class="pdm-info-label">Budget Range</span>
                                <span class="pdm-info-value" id="infoBudget"></span>
                            </div>

                            {{-- Description --}}
                            <div class="pdm-info-section">
                                <span class="pdm-info-section-title">Description</span>
                                <p class="pdm-info-description" id="infoDescription"></p>
                            </div>

                            {{-- Specifications --}}
                            <div class="pdm-info-section">
                                <span class="pdm-info-section-title">Specifications</span>
                                <div class="pdm-info-specs" id="infoSpecs"></div>
                            </div>
                        </div>
                    </div>
                </div>
