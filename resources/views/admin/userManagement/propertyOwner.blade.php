                ...
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg">
                  <div class="flex items-start">
                    ...
                    <div class="ml-3">
                      ...
                      <p class="text-sm text-blue-600 mt-1">
                        The username will be <span class="font-mono font-bold bg-blue-100 px-1 rounded">owner_</span>
          ...
          <div>
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <div
                  class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-orange-400 transition cursor-pointer bg-gray-50 hover:bg-orange-50"
        ...
        <form id="editPropertyOwnerForm">
          ...
          <div class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Contact no.</label>
                <input type="tel" id="edit_phone_number" name="phone_number" placeholder="Enter contact number"
                  class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-400 focus:border-transparent transition">
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <div
                    class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-orange-400 transition cursor-pointer bg-gray-50 hover:bg-orange-50"
                    id="editPoliceClearanceUploadArea">
