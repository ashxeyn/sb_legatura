        ...
        $popSearchForm = '
          <form class="flex items-center gap-2" method="GET" action="' . route('admin.globalManagement.proofOfpayments') . '" style="width: 600px;">
            <div class="relative flex-1">
              <input type="text" name="search" value="' . e(request('search')) . '" placeholder="Search project or contractor..." class="border border-gray-300 rounded-lg px-4 py-2 pr-10 focus:ring-2 focus:ring-indigo-400 focus:outline-none w-full">
            ...
            ' . (request('search') || request('status') ? '<a href="' . route('admin.globalManagement.proofOfpayments') . '" class="px-3 py-2 border border-gray-300 text-gray-600 rounded-lg text-sm hover:bg-gray-50 transition">Clear</a>' : '') . '
          </form>';
      @endphp
      @include('admin.layouts.topnav', [
          'pageTitle' => 'Proof of Payments',
          'hideSearch' => true,
          'beforeNotifications' => $popSearchForm,
      ])
