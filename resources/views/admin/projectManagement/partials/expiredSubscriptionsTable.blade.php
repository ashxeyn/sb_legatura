@forelse($expiredSubscriptions as $sub)
  ...
  <tr class="hover:bg-indigo-50/60 transition-colors">
    ...
    <td class="px-2.5 py-2.5 whitespace-nowrap text-red-600 text-[11px] font-medium">
...
@empty
  <tr>
    <td colspan="6" class="px-4 py-12 text-center text-gray-400">
      ...
      <p class="text-base font-medium text-gray-500">No expired subscriptions found.</p>
    </td>
  </tr>
@endforelse
