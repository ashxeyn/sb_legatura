  ...
  <div class="absolute inset-0 flex items-center justify-center p-4">
    <div class="bg-white w-full max-w-5xl rounded-2xl shadow-2xl relative transform transition-all duration-300 scale-100 max-h-[90vh] overflow-hidden flex flex-col">
      ...
      <div class="relative px-6 py-10 bg-gradient-to-r from-gray-600 to-gray-700 text-white flex-shrink-0">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                      ...
                      <td class="px-4 py-3">
                        @if($payment->receipt_photo)
                          <a href="#" class="open-doc-btn inline-flex items-center gap-1 text-blue-600 hover:text-blue-700 font-medium hover:underline text-xs" data-doc-src="{{ asset('storage/' . $payment->receipt_photo) }}" data-doc-title="Proof of Payment">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Footer -->
        <div class="border-t border-gray-200 px-6 py-4 bg-gray-50 rounded-b-2xl flex justify-between items-center flex-shrink-0">
          ...
          <button type="button" onclick="hideCancelledProjectModal()" class="px-6 py-2.5 text-sm font-semibold rounded-lg border-2 border-gray-300 text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 flex items-center gap-2">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
            </svg>
            Close
