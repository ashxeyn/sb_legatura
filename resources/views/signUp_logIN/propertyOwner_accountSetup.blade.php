			...
			<form class="setup-form" method="POST" action="{{ route('owner.account-setup') }}">
				...
				<div class="form-step active" id="step-1">
					...
					<div class="field-grid-2col">
						<div class="field-block">
							<label class="field-label">First name <span style="color: #ef4444;">*</span></label>
							<label class="field">
						...
						<div class="field-block">
							<label class="field-label" style="display:block; margin-bottom:6px; font-weight:500;">Middle
								name (Optional)</label>
							<label class="field">
								<span class="field-icon" aria-hidden="true"><i class="fi fi-rr-user"></i></span>
								<input type="text" name="middle_name" placeholder="Middle name (optional)"
									maxlength="100" value="{{ old('middle_name', request('middle_name')) }}">
							</label>
						</div>

						<div class="field-block">
							<label class="field-label">Last name <span style="color: #ef4444;">*</span></label>
							<label class="field">
								<span class="field-icon" aria-hidden="true"><i class="fi fi-rr-user"></i></span>
						...
						<div class="field-block">
							<label class="field-label">Occupation <span style="color: #ef4444;">*</span></label>
							<input type="hidden" name="occupation_id" id="occupationValue"
								value="{{ old('occupation_id', request('occupation_id')) }}" required />
							<label class="field">
						...
						<div class="field-block" id="occupationOtherBlock"
							style="display: {{ old('occupation_other', request('occupation_other')) ? 'block' : 'none' }};">
							<label class="field-label">Specify Occupation <span style="color: #ef4444;">*</span></label>
							<label class="field">
								<span class="field-icon" aria-hidden="true"><i class="fi fi-rr-briefcase"></i></span>
								<input type="text" name="occupation_other" id="occupationOther"
									placeholder="Please specify"
									value="{{ old('occupation_other', request('occupation_other')) }}">
							</label>
						</div>

						<div class="field-block">
							<label class="field-label">Date of birth <span style="color: #ef4444;">*</span></label>
							<label class="field">
							...
							<small style="font-size: 12px; color: #666; margin-top: 4px; display: block;">Must be 18+
								years old</small>
						</div>
						...
						<div class="field-block">
							...
							<label class="field">
								...
								<input type="tel" name="phone_number" placeholder="09171234567" pattern="09[0-9]{9}"
									maxlength="11" required value="{{ old('phone_number', request('phone_number')) }}">
							</label>
							<small style="font-size: 12px; color: #666; margin-top: 4px; display: block;">11 Digits
								Start with 09</small>
						</div>
					</div>
					...
					<div class="field-grid-2col">
						<div class="field-block" style="grid-column: 1 / -1;">
							<label class="field-label">Street/Building No. <span
									style="color: #ef4444;">*</span></label>
							<label class="field">
								<span class="field-icon" aria-hidden="true"><i class="fi fi-rr-marker"></i></span>
								<input type="text" name="owner_address_street" placeholder="Street/Building No."
									required value="{{ old('owner_address_street', request('owner_address_street')) }}">
							</label>
						</div>

						<div class="field-block">
							<label class="field-label">Province <span style="color: #ef4444;">*</span></label>
							<input type="hidden" name="owner_address_province" id="provinceValue"
								value="{{ old('owner_address_province', request('owner_address_province')) }}"
								required />
							<label class="field">
						...
						<div class="field-block">
							<label class="field-label">City/Municipality <span style="color: #ef4444;">*</span></label>
							<input type="hidden" name="owner_address_city" id="cityValue"
								value="{{ old('owner_address_city', request('owner_address_city')) }}" required />
							<label class="field">
								<span class="field-icon" aria-hidden="true"><i class="fi fi-rr-map-marker"></i></span>
						...
						<div class="field-block">
							<label class="field-label">Barangay <span style="color: #ef4444;">*</span></label>
							<input type="hidden" name="owner_address_barangay" id="barangayValue"
								value="{{ old('owner_address_barangay', request('owner_address_barangay')) }}"
								required />
							<label class="field">
								<span class="field-icon" aria-hidden="true"><i class="fi fi-rr-map-marker"></i></span>
						...
						<div class="field-block">
							<label class="field-label">Postal Code <span style="color: #ef4444;">*</span></label>
							<label class="field">
								<span class="field-icon" aria-hidden="true"><i class="fi fi-rr-envelope"></i></span>
								<input type="text" name="owner_address_postal" placeholder="Postal Code"
									pattern="[0-9]{4}" maxlength="4" required
									value="{{ old('owner_address_postal', request('owner_address_postal')) }}">
							</label>
						</div>
					</div>
				</div>
						...
						<div class="field-block" style="grid-column: 1 / -1;">
							...
							<label class="field">
								...
								<input type="text" name="username" id="usernameInput" placeholder="Username"
									maxlength="50" required value="{{ old('username', request('username')) }}">
							</label>
						</div>
						...
						<div class="field-block" style="grid-column: 1 / -1;">
							...
							<label class="field password-field">
								...
								<input type="password" name="password" id="passwordInput" placeholder="Password"
									required value="{{ old('password', request('password')) }}">
				...
				<div class="form-step" id="step-3">
					<div class="field-grid-2col grid-verification">
						<div class="field-block" style="grid-column: 1 / -1;">
							<label class="field-label">Type of valid ID <span style="color: #ef4444;">*</span></label>
							<input type="hidden" name="valid_id_id" id="validIdValue"
								value="{{ old('valid_id_id', request('valid_id_id')) }}" required />
							<label class="field">
						...
						<div class="field-block">
							<label class="field-label">Valid ID - Front Side <span
									style="color: #ef4444;">*</span></label>
							<div class="upload-area" id="uploadArea1">
								...
								<input type="file" name="valid_id_photo" class="upload-input" id="validIdFrontInput"
									accept="image/jpeg,image/jpg,image/png,application/pdf">
							</div>
						</div>

						<div class="field-block">
							<label class="field-label">Valid ID - Back Side <span
									style="color: #ef4444;">*</span></label>
							<div class="upload-area" id="uploadArea2">
								...
								<input type="file" name="valid_id_back_photo" class="upload-input" id="validIdBackInput"
									accept="image/jpeg,image/jpg,image/png,application/pdf">
							</div>
						</div>
						...
						<div class="field-block">
							<label class="field-label">Police Clearance <span style="color: #ef4444;">*</span></label>
							<div class="upload-area" id="uploadArea3">
								...
								<input type="file" name="police_clearance" class="upload-input"
									id="policeClearanceInput" accept="image/jpeg,image/jpg,image/png,application/pdf">
							</div>
						</div>
					</div>
