    ...
    <div class="modal-container">
        <div class="modal-content">
            ...
            <div class="modal-buttons-row">
                <button type="button" class="modal-button modal-button-secondary" onclick="handleEditBudget('{{ $projectId }}')">
                    Edit
                </button>
                <button type="button" class="modal-button modal-button-primary" onclick="handleContinueBudget('{{ $projectId }}')">
                    Continue
                </button>
            </div>
        </div>
